...
lappend arg_list "--report-file=csv:sdrammem_example.csv"
lappend arg_list "--report-file=qip:sdrammem_example.qip"
lappend arg_list "--output-name=sdrammem_example"
...
lappend arg_list "--component-param=MEM_CLK_FREQ=400.0"
...
lappend arg_list "--component-param=MEM_VENDOR=Elpida"
...
lappend arg_list "--component-param=TIMING_TDH=150"
...
lappend arg_list "--component-param=TIMING_TDS=75"
...
catch { eval [concat [list exec "C:/intelfpga_lite/16.1/quartus//sopc_builder/bin/ip-generate" --component-name=alt_mem_if_ddr3_tg_ed] $arg_list] } temp
puts $temp
